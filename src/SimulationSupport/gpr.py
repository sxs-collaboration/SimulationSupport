...
class GPRegressionModel(gpytorch.models.ExactGP):
    ...
    def __init__(self, train_x, train_y, likelihood):
        ...
        # Smoothness parameter of Matern Kernel is ν=5/2 (nu=2.5); chosen to
        # allow GPR to model curvature and capture both smooth global trends (RBF)
        # and local variations (Matern)
